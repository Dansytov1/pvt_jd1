...
public class BarberShop {
    ...
    public void addMoneyToCash(Integer integer) {
        if (cash == null)
            cash = new ArrayList<>(); //ленивая инициализация, инициализируем объект только там, где к нему доступаются
        cash.add(integer);
    }
    ...
    public synchronized void newClient(){
        try {
            ...
            System.out.println("BarberShop: new client in Barbershop: "+clientName);
